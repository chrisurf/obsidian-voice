    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .addOption("1.7", "70% faster")
          .addOption("1.6", "60% faster")
          .addOption("1.5", "50% faster")
          .addOption("1.4", "40% faster")
          .addOption("1.3", "30% faster")
          .addOption("1.1", "20% faster")
          .addOption("1.2", "10% faster")
          .addOption("1.0", "normal")
          .addOption("0.9", "10% slower")
          .addOption("0.8", "20% slower")
          .addOption("0.7", "30% slower")
          .addOption("0.6", "40% slower")
